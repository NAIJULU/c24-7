...
<td>
    <div class="span6 rw-ui-img-radio<?php if ($type == "star") echo " rw-selected";?>" onclick="RWM.Set.type(RW.TYPE.STAR);">
    ...
    <div class="span6 rw-ui-img-radio<?php if ($type == "nero") echo " rw-selected";?>" onclick="RWM.Set.type(RW.TYPE.NERO);">
